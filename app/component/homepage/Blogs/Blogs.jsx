        ...
        <div className="pt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link>
            <article className="flex flex-col gap-2">
              <img src={blogImg1} alt="Blog 1" loading="lazy" className="max-h-[300px] mb-3 h-[300px] object-cover rounded-2xl max-w-[558px]" />
          ...
          <Link>
            <article className="flex flex-col gap-2">
              <img src={blogImg2} alt="Blog 1" loading="lazy" className="max-h-[300px] mb-3 h-[300px] object-cover rounded-2xl max-w-[558px]" />
          ...
          <Link to={"/blog"}>
            <article className="flex flex-col gap-2">
              <img src={blogImg3} alt="Blog 1" loading="lazy" className="max-h-[300px] mb-3 h-[300px] object-cover rounded-2xl max-w-[558px]" />
